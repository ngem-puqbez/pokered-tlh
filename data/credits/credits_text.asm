...
IF DEF(_RED)
	db -7, "<Q><u><j> <S><a><r> <D><o><q> <b><e><q>@"
ENDC
IF DEF(_BLUE)
	db -7, "<Q><u><j> <S><a><r> <S><u><D> <b><e><q>@"
ENDC
CredTajiri:
	db -6, "SATOSHI TAJIRI@"
CredTaOota:
...
CredDirector:
	db -2, "<D><e><v><w><I><'>@"
CredProgrammers:
	db -4, "<g><h><u><n><w><I><'><p><u><'>@"
CredCharDesign:
	db -5, "<g><h><o><t> <r><e><n><w><I><'>@"
CredMusic:
	db -1, "<Q><o><Q>@"
CredSoundEffects:
	db -2, "<w><a><b><m><e><y>@"
CredGameDesign:
	db -4, "<Q><u><j> <r><e><n><w><I><'>@"
CredMonsterDesign:
	db -7, "<t><l><h><a><p><r><a><g><h> <r><e><n><w><I><'>@"
CredGameScene:
	db -4, "<l><u><t> <q><o><n><w><I><'>@"
CredParam:
	db -4, "<n><a><b> <S><I><m><w><I><'>@"
CredMap:
	db -6, "<p><u><'><j><I><n> <r><e><n><w><I><'>@"
CredTest:
	db -6, "<Q><u><j> <w><a><H><w><I><'><p><u><'>@"
CredSpecial:
	db -6, "<q><u><v><w><I><'><p><u><'> <l><I><'>@"
CredProducers:
	db -4, "<v><u><'><w><I><'><p><u><'>@"
CredProducer:
	db -2, "<v><u><'><w><I><'>@"
...
CredToOota:
	db -6, "TOMOMICHI OOTA@"
CredUSStaff:
	db -6, "<S><e><p><j><I><j><Q><a><'> <b><e><q>@"
CredUSCoord:
	db -7, "<S><e><p><j><I><j><Q><a><'> <Q><u><m><w><I><'>@"
CredTilden:
	db -5, "GAIL TILDEN@"
CredKawakami:
	db -6, "NAOKO KAWAKAMI@"
...
CredOsborne:
	db -5, "SARA OSBORNE@"
CredTrans:
	db -8, "<D><I><v><I><'> <H><o><l> <m><u><g><h><w><I><'>@"
CredOgasawara:
	db -6, "NOB OGASAWARA@"
CredIwata:
	db -5, "SATORU IWATA@"
...
CredPAAD:
	db -5, "PAAD TESTING@"
CredMyka:
	db -7, "MYKA NGEM PUQBE'@"
CredKli:
	db -9, "<t><l><h><I><n><g><a><n> <H><o><l> <m><u><g><h><w><I><'>@"
